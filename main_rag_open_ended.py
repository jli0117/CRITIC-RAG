...
class Runner(object):
    ...
    def eval(self):
        ...
        for index, batch in enumerate(tqdm(self.qa_data_loaders['test'])):
            ...
            results['dataset_correct_answers'].append([element['answer'] for element in batch])
        ...
        return {
            ...
            'dataset_correct_answers': results['dataset_correct_answers'],
    ...
    def save_llm_answers(self, epoch, eval_result):
        ...
        all_correct_answer = list(itertools.chain.from_iterable(eval_result["dataset_correct_answers"]))
        ...
        with open(save_path, "w", encoding="utf-8") as file:
            for i in range(len(eval_result['llm_answers'])):
                combined_record = {
                    ...
                    "correct_answer": all_correct_answer[i],
