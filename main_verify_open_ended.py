    ...
    def eval(self):
        ...
        for index, batch in enumerate(tqdm(self.qa_data_loaders['test'])):
            ...
            if batch_noret:
                ...
                all_correct_noret.extend([sample['answer'] for sample in batch_noret])
            ...
            if batch_ret:
                ...
                ret_correct = [sample['answer'] for sample in batch_ret]  # Correct answers for retrieval samples
                    ...
                    if filtered_k:
                        if len(filtered_k) <= self.ver_args.verifier_num_clusters:
                            ...
                            for docs in sampled_docs:
                                ...
                                try:
                                    gpt_score_letter = generate_label(prompt_isGRD, "") 
            ...
            results['dataset_correct_answers'].extend(all_correct_noret + all_correct_ret)
        ...
        with open(save_path, "w", encoding="utf-8") as file:
            for i in range(len(eval_result['llm_answers'])):
                combined_record = {
                    ...
                    "correct_answer": eval_result['dataset_correct_answers'][i],
